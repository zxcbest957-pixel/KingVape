...
pcall(downloadFile, 'kingvape/profiles/features.json')
local moduleData = loadJson('kingvape/profiles/features.json') or loadJson('profiles/features.json') or {}
...
function mainapi:Save(newprofile)
	...
	writefile('kingvape/profiles/'..game.GameId..'.gui.txt', httpService:JSONEncode(guidata))
	writefile('kingvape/profiles/'..self.Profile..self.Place..'.txt', httpService:JSONEncode(savedata))
end
...
scarcitybanner.Text = 'Welcome to King Vape! Enjoy your custom client.'
